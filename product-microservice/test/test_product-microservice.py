...
docker cp product-microservice/test/test_product-microservice.py product-microservice-debugger:/app && docker exec product-microservice-debugger /bin/sh -c "python test_product-microservice.py"
"""
...
# Send POST batch
url = deploy_utils.get_resource_path(apig_client, api_id, stage_name = api_stage_name, resource_path = "product-microservice/batch", protocol=PROTOCOL_TO_USE)
payload =   [
    {
    "product_id": "2",
...
####
# !!! OLD CODE, might have wrong request models in payload
