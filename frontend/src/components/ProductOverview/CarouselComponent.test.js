...
test('CarouselComponent displays the correct number of carousel items', () => {
    ...
    render(
        <BrowserRouter>
            <CarouselComponent carouselData={mockCarouselData} clickable={true} onCardInteract={jest.fn()} />
        </BrowserRouter>
    );
